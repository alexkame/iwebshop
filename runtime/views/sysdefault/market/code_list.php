...
<body>
    ...
    <div class="operating">
        <a href="javascript:;" onclick="event_link('<?php echo IUrl::creatUrl("/market/code_edit");?>')"><button class="operating_btn" type="button"><span class="addition">生成激活码</span></button></a>
...
<script type='text/javascript'>
    $("#jihuo").click(function(){
        ...
        if(str)
        {
            $.get('<?php echo IUrl::creatUrl("/market/daijin");?>',{'str':str},function(obj){
